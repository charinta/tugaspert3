...
class _LoginPageState extends State<LoginPage> {
  ...
  _showInput(namacontroller, placeholder, isPassword, icon) {
    IconData iconUse = icon == 'person' ? Icons.person : Icons.password;
    return TextField(
      controller: namacontroller,
      obscureText: isPassword,
      decoration: InputDecoration(
        hintText: placeholder,
        prefixIcon: Icon(iconUse),
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            _showInput(
                _usernameController, 'Masukkan Username', false, "person"),
            const SizedBox(
              height: 16,
            ),
            _showInput(
                _passwordController, 'Masukkan Password', true, "password"),
            const SizedBox(
              height: 16,
            ),
            SizedBox(
